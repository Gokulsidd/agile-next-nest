...
export type ConfigurationContextType = {
  ...
  REQUIREMENTS_LIST_COUNT: number
}
...
export const ConfigurationProvider: React.FC<Props> = ({ children }) => {
  ...
  const REQUIREMENTS_LIST_COUNT = values.REQUIREMENTS_LIST_COUNT
  const MAX_REQUIREMENTS = values.MAX_REQUIREMENTS
