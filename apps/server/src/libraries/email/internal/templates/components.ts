export const Components: Record<string, string> = {
  ...
  '</h2>': '</h2></td></tr>',
  '<hr />': '<tr><td><hr /></td></tr>',
  '<Button>': '<tr><td><a class="button" href="', // Button with hyperlink
  '</Button>':
    '" style="display:inline-block;padding:10px 20px;font-size:16px;text-align:center;color:#fff;background-color:#000000;text-decoration:none;border-radius:5px;">Verify Account</a></td></tr>',
}
